...
LATENT_PATH = 'latent_trained_labels.npy'
...
vae = vamb.encode.VAELabels(nlabels=len(set(classes_order)), cuda=CUDA)
dataloader, mask = vamb.encode.make_dataloader_labels(rpkms, tnfs, classes_order)
